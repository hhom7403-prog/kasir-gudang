            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->hasRole('admin', 'kasir'))
                        <x-nav-link :href="route('kasir.index')" :active="request()->routeIs('kasir.*')">Kasir</x-nav-link>
                    @endif
                    @if(Auth::user()->hasRole('admin', 'gudang'))
                        <x-nav-link :href="route('stok.index')" :active="request()->routeIs('stok.*')">Stok</x-nav-link>
                    @endif
                    @if(Auth::user()->hasRole('admin'))
                        <x-nav-link :href="route('produk.index')" :active="request()->routeIs('produk.*')">Produk</x-nav-link>
                        <x-nav-link :href="route('gudang.index')" :active="request()->routeIs('gudang.*')">Gudang</x-nav-link>
